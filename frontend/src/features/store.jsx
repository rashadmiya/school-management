...
import { parentAuthApi } from "./apis/parentAuthApi";
import { parentPortalApi } from "./apis/parentPortalApi";
...
const persistConfig = {
    key: "root",
    storage,
    whitelist: ["global"],   // do NOT persist parentAuth — cookie is source of truth
};
...
const rootReducer = combineReducers({
    ...
    [parentAuthApi.reducerPath]: parentAuthApi.reducer,
...
export const makeStore = () => configureStore({
    ...
    middleware: (getDefaultMiddleware) =>
        getDefaultMiddleware({
            ...
            .concat(parentAuthApi.middleware)
