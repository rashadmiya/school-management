// // src/features/apis/finance/feeApi.js
// import { api } from '../../api';
...
//             providesTags: (r, e, id) => [{ type: 'FeeTemplate', id }],
//         }),
...
//                 body: data,
//             }),
//             invalidatesTags: (r, e, { id }) => [{ type: 'FeeTemplate', id }, 'FeeTemplate'],
//         }),
...
//             query: (templateId) => `/fees/templates/${templateId}/eligible-students`,
...
//                 body: { force },
//             }),
//             invalidatesTags: ['FeeTemplate', 'FeeInstance', 'Ledger', 'Student', 'Bill'],
//         }),
...
//                 body: updates,
//             }),
//             invalidatesTags: ['FeeInstance', 'Ledger', 'Bill'],
//         }),
...
export const feeApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    applyFeeTemplate: builder.mutation({
      ...
      invalidatesTags: ['FeeInstance', 'Ledger', 'Student', 'FeeTemplate'],
    }),
    ...
    // === Instances ===
    getFeeInstance: builder.query({
      query: (id) => `/fees/instances/${id}`,
      providesTags: (result, error, id) => [{ type: 'FeeInstance', id }],
    }),
    ...
    // === Session ===
    // creating useSetSessionMutation
...
//     getFeeCollectionReport: builder.query({
//       query: ({ startDate, endDate, classId, session }) => ({
//         url: '/reports/collection/fees', // ✅ This resolves to /api/s2/reports/collection/fees
//         params: { startDate, endDate, classId, session },
//       }),
//       providesTags: ['Report'],
//     }),
