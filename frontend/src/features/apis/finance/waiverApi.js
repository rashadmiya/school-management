// src/features/apis/finance/waiverApi.js
import { api } from '../api';
...
export const waiverApi = api.injectEndpoints({
    endpoints: (builder) => ({
        requestWaiver: builder.mutation({
            ...
            invalidatesTags: ['Waiver', 'FeeInstance', 'Ledger', 'Bill', 'Statement'],
        }),
        ...
        getEligibleWaiver: builder.query({
            query: (feeInstanceId) => `/waivers/eligible/${feeInstanceId}`,
            providesTags: (r, e, feeInstanceId) => [{ type: 'Waiver', id: feeInstanceId }],
        }),
