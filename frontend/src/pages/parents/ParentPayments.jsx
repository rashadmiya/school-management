// pages/parent/ParentPayments.jsx
...
import { Download, FileText, User, Wallet } from "lucide-react";
                                ...
                                {children.map((child) => {
                                    ...
                                    return (
                                        <TableRow key={child._id}>
                                            ...
                                            <TableCell className={`text-right font-semibold ${Number(s.dueBalance) > 0 ? "text-rose-600" : "text-gray-500"
                                                }`}>
                                                ...
                                                <div className="flex gap-2">
                                                    {Number(s.dueBalance) > 0 && (
                                                        <Button
                                                            ...
                                                            asChild
                                                        >
                                                            <Link to={`/parent/payments/pay?child=${child._id}`}>
                                                                Pay
                                                            </Link>
                                                        </Button>
                                                    )}
