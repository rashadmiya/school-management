...
import { Award, Edit, Filter, MapPin, Phone, Plus, Quote, Search, Trash2, User, X } from "lucide-react";
        ...
        return (
            <Card className={`${theme.bgCard} ${theme.border} shadow-sm`}>
                <CardContent className="p-6">
                    <div className={`text-center ${theme.textMuted}`}>Loading committee data...</div>
                </CardContent>
            </Card>
        );
    }
                    ...
                    <div className="overflow-x-auto">
                        <Table>
                            <TableHeader className={`${theme.tableHeader} border-b ${theme.border}`}>
                                <TableRow>
                                    <TableHead className={`w-16 ${theme.textSecondary}`}>Order</TableHead>
                                    <TableHead className={theme.textSecondary}>Name</TableHead>
                                    <TableHead className={theme.textSecondary}>Designation</TableHead>
                                    <TableHead className={theme.textSecondary}>Quote</TableHead>
                            ...
                            <TableBody>
                                {committee.length === 0 ? (
                                    <TableRow className={theme.tableRow}>
                                        <TableCell colSpan={8} className={`text-center py-8 ${theme.textMuted}`}>
                                                ...
                                                <TableRow key={member._id} className={`border-b ${theme.tableRow}`}>
                                                    <TableCell>
                                                        <div className="flex items-center justify-center">
                                                            <Badge variant="outline" className={`font-mono ${theme.badge.outline}`}>
                                                                {member.order}
                                                            </Badge>
                                                        </div>
                                                    </TableCell>
                                                    ...
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <Badge 
                                                                ...
                                                                className={
                                                                    member.designation === "chairman" ? theme.badge.default :
                                                                    member.designation === "secretary" ? theme.badge.secondary :
                                                                    theme.badge.outline
                                                                }
                                                            >
                                                                {designationLabel}
                                                    ...
                                                    <TableCell>
                                                        <div className="flex items-center gap-2">
                                                            <Quote className={`w-4 h-4 ${theme.textMuted}`} />
